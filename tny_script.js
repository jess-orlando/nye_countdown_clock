...
// Function to create setInterval() method to keep runClock() going
...
// Store the current date and time
   ...
   // Calculate the hours left until NYE
   let hrsLeft = (daysLeft - Math.floor(daysLeft)) * 24;

   // Calculate the minutes left until NYE
   let minsLeft = (hrsLeft - Math.floor(hrsLeft)) * 60;

   // Calculate the seconds left until NYE
